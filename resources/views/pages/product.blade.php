            ...
            <div class="col-lg-5">
                ...
                <div class="tab-content">
                    <div id="thumb" class="tab-pane active">
                        @if (!$product->image)
                        <a data-fancybox="images" href="storage/{{ $product->image }}">
                            <img src="storage/{{ $product->image }}" alt="product-view">
                        </a>
                        @else
                    ...
                    <div id="thumb{{$key}}" class="tab-pane">
                        <a data-fancybox="images" href="storage/{{ $image }}">
                            <img src="storage/{{ $image }}" alt="product-view">
                        </a>
                    </div>
                    @endforeach
                    @else
                ...
                <div class="product-thumbnail">
                    <div class="thumb-menu nav">
                        ...
                        <a data-toggle="tab" href="#thumb{{$key}}">
                            <img src="storage/{{ $image }}" alt="product-thumbnail">
                        </a>
                        @endforeach
                        @else
