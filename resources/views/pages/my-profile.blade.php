            ...
            <div class="row">
                <div class="col-lg-2">
                    ...
                    <ul class="nav flex-column dashboard-list" role="tablist">
                        ...
                        <li><a href="" href="#logout">logout</a></li>
                    </ul>
                </div>
                <div class="col-lg-10">
                    <!-- Tab panes -->
                                ...
                                <form action="#">
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-lg-6 col-md-8">
                                            <span class="custom-radio"><input name="id_gender" value="1" type="radio">
                                                Mr.</span>
                                            <span class="custom-radio"><input name="id_gender" value="1" type="radio">
                                                Mrs.</span>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputpassword" class="col-lg-3 col-md-4 col-form-label">Current
                                            password</label>
                                        <div class="col-lg-6 col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label for="v-password" class="col-lg-3 col-md-4 col-form-label">Confirm
                                            password</label>
                                        <div class="col-lg-6 col-md-8">
