                    ...
                    <div class="tab-content fix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="">
                                                <img class="primary-img" src="{{ asset('/img/products/5.jpg') }}"
                                                    alt="single-product">
                                                <img class="secondary-img" src="{{ asset('/img/products/6.jpg') }}"
                                                    alt="single-product">
                                            </a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="">
                                                <img class="primary-img" src="{{ asset('/img/products/7.jpg') }}"
                                                    alt="single-product">
                                                <img class="secondary-img" src="{{ asset('/img/products/8.jpg') }}"
                                                    alt="single-product">
                                            </a>
                                        </div>
                                        <!-- Product Image End -->
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="">
                                                <img class="primary-img" src="{{ asset('/img/products/2.jpg') }}"
                                                    alt="single-product">
                                                <img class="secondary-img" src="{{ asset('/img/products/1.jpg') }}"
                                                    alt="single-product">
                                            </a>
                                        </div>
                                        <!-- Product Image End -->
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="">
                                                <img class="primary-img" src="{{ asset('/img/products/6.jpg') }}"
                                                    alt="single-product">
                                                <img class="secondary-img" src="{{ asset('/img/products/5.jpg') }}"
                                                    alt="single-product">
                                            </a>
                                        </div>
                                        <!-- Product Image End -->
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-img">
                                            <a href="">
                                                <img class="primary-img" src="{{ asset('/img/products/7.jpg') }}"
                                                    alt="single-product">
                                                <img class="secondary-img" src="{{ asset('/img/products/7.jpg') }}"
                                                    alt="single-product">
                                            </a>
                                        </div>
                                        <!-- Product Image End -->
                        ...
                        <div id="list-view" class="tab-pane active">
                            ...
                            <div class="single-product">
                                ...
                                <div class="pro-img">
                                    <a href="">
                                        <img class="primary-img" src="{{ asset('/img/products/8.jpg') }}"
                                            alt="single-product">
                                        <img class="secondary-img" src="{{ asset('/img/products/7.jpg') }}"
                                            alt="single-product">
                                    </a>
