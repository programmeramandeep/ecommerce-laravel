...
class DataRowsTableSeederCustom extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataRow = $this->dataRow($ordersDataType, 'billing_country');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($ordersDataType, 'billing_order_notes');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'Biiling Order Notes',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 0,
        ...
        $dataRow = $this->dataRow($ordersDataType, 'billing_discount_details');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'Biiling Discount Details',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 0,
